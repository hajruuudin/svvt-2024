    ...
    public static String[][][] f1_2021_season = {
            {
                    ...
                    {"Podium Finish in 2021"}
            },
            {
                    {"Bahrain", "Bahrain International Circuit", "2004", "57", "5.412 km", "1:31.447", "Pedro de la Rosa"},
            ...
            {
                    {"Spain", "Circuit de Barcelona-Catalunya", "1991", "66", "4.675 km", "1:18.149", "Max Verstappen"},
                    {"Lewis Hamilton", "Max Verstappen", "Valtteri Bottas"}
            },
            {
                    {"Monaco", "Circuit de Monaco", "1950", "78", "3.337 km", "1:12.909", "Lewis Hamilton"},
                    {"Max Verstappen", "Carlos Sainz", "Lando Norris"}
            },
            {
                    {"Azerbaijan", "Baku City Circuit", "2016", "51", "6.003 km", "1:43.009", "Charles Leclerc"},
                    {"Sergio Perez", "Sebastian Vettel", "Pierre Gasly"}
            },
            {
                    {"France", "Circuit Paul Ricard", "1971", "53", "5.842 km", "1:32.740", "Sebastian Vettel"},
            ...
            {
                    {"Austria", "Red Bull Ring", "1970", "71", "4.318 km", "1:05.619", "Carlos Sainz"},
                    {"Max Verstappen", "Valtteri Bottas", "Lando Norris"}
            },
            {
                    {"Great Britain", "Silverstone Circuit", "1950", "52", "5.891 km", "1:27.097", "Max Verstappen"},
                    {"Lewis Hamilton", "Charles Leclerc", "Valtteri Bottas"}
            },
            {
                    {"Hungary", "Hungaroring", "1986", "70", "4.381 km", "1:16.627", "Lewis Hamilton"},
                    {"Esteban Ocon", "Lewis Hamilton", "Carlos Sainz"}
            },
            {
                    {"Belgium", "Circuit de Spa-Francorchamps", "1950", "44", "7.004 km", "1:46.286", "Valtteri Bottas"},
                    {"Max Verstappen", "George Russell", "Lewis Hamilton"}
            },
            {
                    {"Netherlands", "Circuit Zandvoort", "1952", "72", "4.259 km", "1:11.097", "Lewis Hamilton"},
                    {"Max Verstappen", "Lewis Hamilton", "Valtteri Bottas"}
            },
            {
            ...
            {
                    {"Russia", "Sochi Autodrom", "2014", "53", "5.848 km", "1:35.761", "Lewis Hamilton"},
            ...
            {
                    {"Mexico", "Autódromo Hermanos Rodríguez", "1963", "71", "4.304 km", "1:17.774", "Valtteri Bottas"},
                    {"Max Verstappen", "Lewis Hamilton", "Sergio Perez"}
            },
            {
            ...
            {
                    {"Abu Dhabi", "Yas Marina Circuit", "2009", "58", "5.554 km", "1:26.103", "Max Verstappen"},
